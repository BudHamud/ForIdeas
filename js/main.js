...
function renderizarProds(arr) {
  arr.forEach((product) => {
    ...
    card.innerHTML += `
            <div class="card border border-start-0 border-3 d-flex flex-column align-items-center">
    ...
    pedido.innerHTML += `
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <button onclick="borrarProd(${product.id})" type="button" class="btn btn-danger text-uppercase rounded-pill" id="borrar-${product.id}">Eliminar producto</button>
